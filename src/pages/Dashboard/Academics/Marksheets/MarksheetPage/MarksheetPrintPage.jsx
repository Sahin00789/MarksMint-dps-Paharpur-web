...
const MarksheetPrintPage = ({
  ...
  const student = {
    ...
    rollNo:
      processedStudent?.student?.rollNo || processedStudent?.rollNo || "N/A",
  };
  ...
  const processedExamResults = processedStudent?.marks
    ? Object.entries(processedStudent.marks).map(([examTerm, examData]) => ({
        term: examTerm,
    ...
    >
      ...
      <div
        style={{
          ...
          zIndex: 10,
          boxShadow:
            "inset 0 0 0 3px #fff, inset 0 0 0 5px #d1fae5, inset 0 0 0 6px #fff",
        }}
      ></div>
      <div
        style={{
      ...
      >
        ...
        <div
          style={{
            textAlign: "center",
            background: "linear-gradient(90deg, #d1fae5, #ecfccb, #d1fae5)",
            padding: "4px 0",
            borderRadius: "4px",
            color: "#064e3b",
            fontWeight: 700,
        ...
        <div style={{ display: "flex", gap: "15px", marginBottom: "10px" }}>
          ...
          >
            <div
              style={{ borderLeft: "3px solid #10b981", paddingLeft: "8px" }}
            >
              <div
                style={{
                  fontSize: "9px",
              ...
              <div
                style={{ fontSize: "15px", color: "#065f46", fontWeight: 800 }}
              >
            ...
            >
              ...
              <div
                style={{ fontSize: "15px", color: "#1e293b", fontWeight: 700 }}
              >
                {student.classInfo?.name || student.class || "N/A"}
              </div>
            </div>
            <div
              style={{ borderLeft: "3px solid #f59e0b", paddingLeft: "8px" }}
            >
              <div
                style={{
                  fontSize: "9px",
              ...
              <div
                style={{ fontSize: "15px", color: "#1e293b", fontWeight: 800 }}
              >
                {student.rollNo}
              </div>
            </div>
            <div
              style={{ borderLeft: "3px solid #64748b", paddingLeft: "8px" }}
            >
              <div
                style={{
                  fontSize: "9px",
        ...
        >
          ...
          >
              ...
              >
                {processedExamResults.map((exam, idx) => {
                  const evalTypes = Array.from(
                    new Set(
                      Object.values(exam.subjectDetails).flatMap(
                        (s) => s.evaluations?.map((ev) => ev.type) || []
                      )
                    )
                  );
                    ...
                    <Fragment key={`${idx}-${hIdx}`}>
                      <th
                        style={{
                          ...
                          borderLeft: hIdx === 0 ? "1px solid #fed7aa" : "none",
                        }}
                      >
                        MO
                      </th>
            ...
            <tbody>
              {processedExamResults.length > 0 &&
                Object.keys(processedExamResults[0].subjectDetails)
                  .slice(0, 10)
                    ...
                    return (
                      <tr
                        ...
                        style={{
                          ...
                          backgroundColor: isEven ? "#fff" : "#fcfaf9",
                        }}
                      >
                        <td
                          style={{
                        ...
                        {processedExamResults.map((exam, i) => {
                          ...
                          return evalTypes.map((type, tIdx) => {
                            const evaluation = subjectInfo?.evaluations?.find(
                              (ev) => ev.type === type
                            );
                            return (
                              <Fragment key={`${i}-${tIdx}`}>
                        ...
                        <td
                          style={{
                            ...
                            fontSize: "14px",
                            color: "#064e3b",
                            background: isEven ? "#f0fdf4" : "#ecfccb",
                            borderLeft: "1px solid #f1f5f9",
                          }}
                        >
                        ...
                        >
                          {Math.round(subjectSummary?.percentage || 0)}%
                        </td>
                        <td
                          style={{
                            textAlign: "center",
              ...
              >
                ...
                {processedExamResults.map((exam, idx) => {
                  ...
                  const examTotal = Object.values(exam.subjectDetails).reduce(
                    (sum, s) => sum + (s.total || 0),
                    0
                  );
                  const examMax = Object.values(exam.subjectDetails).reduce(
                    (sum, s) => sum + (s.max || 0),
                    0
                  );
                ...
                >
                  <span style={{ fontWeight: 800 }}>
                    {Math.round(overallSummary.obtainedMarks)}
                  </span>{" "}
                  <span
                    style={{
                      fontSize: "10px",
                  ...
                  >
                    / {Math.round(overallSummary.totalMarks)}
                  </span>
                </td>
                <td
                  style={{
                ...
                >
                  {Math.round(overallSummary.percentage)}%
                </td>
                <td
                  style={{
                    textAlign: "center",
        ...
        >
          ...
          >
            ...
            >
              {overallSummary.rank}
              <span
                style={{ fontSize: "12px", fontWeight: 500, color: "#a16207" }}
              >
                {" "}
          ...
          <div
            style={{
              background:
                overallSummary.resultStatus === "Pass"
                  ? "linear-gradient(135deg, #dcfce7, #ffffff)"
                  : "linear-gradient(135deg, #fee2e2, #ffffff)",
              border: `1.5px solid ${
                overallSummary.resultStatus === "Pass" ? "#86efac" : "#fca5a5"
              }`,
              borderRadius: "10px",
              padding: "10px",
              textAlign: "center",
        ...
        <div style={{ marginTop: "auto" }}>
          <div style={{ display: "flex", gap: "40px", marginBottom: "15px" }}>
            {["Class Teacher", "Principal", "Parent / Guardian"].map(
              (role, idx) => (
